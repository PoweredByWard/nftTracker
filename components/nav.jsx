...
export default function Navbar() {
	...
	return (
		<aside className="h-screen">
			<div className="flex h-full flex-col w-64 px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
				...
				<div className="flex flex-col justify-between flex-1 mt-6">
					<nav>
						...
						>
							...
							<span className="mx-4 font-medium">My whitelist spots</span>
						</a>
					...
					{session && (
						<div>
							...
							<div className="flex items-between mt-5">
								...
								<button
									onClick={() => signOut()}
									class="border-2 border-transparent bg-red-500 ml-3 py-2 px-4 font-bold uppercase text-white rounded transition-all hover:border-red-500 hover:bg-transparent hover:text-red-500"
								>
									logout
								</button>
							</div>
